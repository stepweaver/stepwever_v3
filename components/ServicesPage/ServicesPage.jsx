        ...
        <div className='mx-auto px-4 sm:px-6 md:px-8 lg:px-6 xl:px-6 2xl:px-6 max-w-none'>
          ...
          <div className='max-w-6xl ml-auto'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6'>
              <div className='p-4 md:p-6 bg-terminal-light/10 cyber-border cyber-border-green card-glow'>
              ...
              <div className='p-4 md:p-6 bg-terminal-light/10 cyber-border cyber-border-yellow card-glow'>
                <div className='flex items-center gap-3 mb-3'>
              ...
              <div className='p-4 md:p-6 bg-terminal-light/10 cyber-border cyber-border-magenta card-glow'>
                <div className='flex items-center gap-3 mb-3'>
