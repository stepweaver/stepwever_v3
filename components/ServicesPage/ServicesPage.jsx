        ...
        <div className='mx-auto px-4 sm:px-6 md:px-8 lg:px-6 xl:px-6 2xl:px-6 max-w-none'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-16'>
            {SERVICES_DATA.quickPickSolutions.map((item) => (
              <article
                key={item.id}
                className='group p-6 rounded-2xl bg-terminal-light/30 backdrop-blur-xl border border-terminal-border hover:bg-terminal-light/40 transition-all duration-200 hover:border-terminal-green/50 card-glow'
              >
