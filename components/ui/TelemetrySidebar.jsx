...
export function TelemetrySidebar({
  ...
  return (
    <div className={`w-full ${className || 'space-y-4'}`}>
      {currentFocus && (
        <div className="border border-neon/20 bg-panel/50 p-4 rounded-sm">
      ...
      {links.length > 0 && (
        <div className="border border-neon/20 bg-panel/50 p-4 rounded-sm sm:col-span-2 xl:col-span-1">
