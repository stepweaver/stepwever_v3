...
export default function TerminalWindow({
  ...
  return (
    ...
    >
      {showHeader && (
        <div className='bg-terminal-light border-b border-terminal-border px-4 py-3 flex items-center gap-4 relative z-[2]'>
          ...
          <div className='text-terminal-text font-ibm text-sm text-shadow-[0_0_2px_rgba(0,255,65,0.5)] flex-grow text-center'>
            {title}
          </div>
        </div>
      )}
