...
export default function TerminalWindow({
  ...
  return (
    <div
      className={`bg-terminal-dark cyber-border cyber-border-green overflow-hidden relative before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-b before:from-transparent before:via-[rgba(0,255,0,0.02)] before:to-transparent before:bg-[length:100%_4px] before:pointer-events-none before:animate-[scanlines_20s_linear_infinite] before:z-[1] animate-pulse-glow ${className}`}
    >
      {showHeader && (
      ...
      <div className='relative z-[2] bg-transparent terminal-glow'>{children}</div>
