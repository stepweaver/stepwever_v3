          ...
          >
            <div className='mb-6 sm:mb-8 flex items-end justify-between gap-4'>
              <div className='min-w-0'>
                <div className='text-xs tracking-[0.18em] text-text-label font-ocr uppercase sm:text-sm'>
                  Featured projects
                </div>
                <h2 className='mt-2 text-xl sm:text-2xl md:text-3xl font-ibm text-terminal-green leading-tight'>
                  Projects
                </h2>
                <p className='mt-3 max-w-3xl text-sm sm:text-base font-ibm text-text-secondary leading-relaxed'>
                  Real builds across web apps, automation, and AI tooling with clear outcomes and production-minded architecture.
                </p>
              </div>
              <Link
                href='/projects'
                className='hidden sm:inline-flex items-center border border-neon/30 px-3 py-2 font-ibm text-sm text-text-secondary transition-colors hover:border-neon/60 hover:text-neon'
              >
                View all projects
              </Link>
            </div>
