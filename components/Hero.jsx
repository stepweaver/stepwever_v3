  ...
  return (
    <section className='relative z-30 min-h-screen flex items-center justify-end'>
      <div className='text-left px-8 md:px-16 lg:px-24 w-full'>
        <h1
          className='text-6xl md:text-8xl lg:text-9xl xl:text-[10rem] mb-10 leading-tight text-right'
        ...
        <p
          className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-terminal-text mb-10 leading-relaxed max-w-4xl ml-auto leading-tight'
        ...
        <p
          className='text-xl md:text-2xl lg:text-3xl text-terminal-text mb-10 leading-relaxed max-w-4xl ml-auto leading-tight'
          style={{ fontFamily: 'var(--font-ocr)' }}
        >
