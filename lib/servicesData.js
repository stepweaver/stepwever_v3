...
export const SERVICES_DATA = {
  ...
  retainers: [
    {
      ...
      period: 'month',
      hours: '5 hrs/mo',
      description: 'Perfect for tweaks, updates, and small tasks',
      features: [
  ...
  customWork: {
    ...
    description: 'Any quick-pick item can be expanded into a custom solution or combined into a comprehensive package.',
    benefits: [
  ...
  retainers: [
    {
      ...
      description: 'Perfect for one-time projects or specific improvements.',
      features: [
        'Flexible hourly engagement',
        'Clear project scope and timeline',
        'No long-term commitments',
        'Ideal for specific automation or development needs'
      ]
    },
    {
      type: 'monthly',
      title: 'Monthly Retainer',
      description: 'Ongoing support for continuous optimization and growth.',
      features: [
