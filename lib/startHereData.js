...
export const START_HERE_TRACKS = [
    ...
    projects: [
      {
        ...
        note: 'Contractor lead ops: evidence + contact paths → analyst-style review → approval-gated drafts',
      },
  ...
  },
  {
    ...
    projects: [
      ...
      { slug: 'bill-planner', label: 'λledger', note: 'Paycheck-window bill planner · Auth.js + Neon + Drizzle ORM' },
    ],
