...
export const briefData = {
  ...
  flagshipProjects: [
    ...
    },
    {
      slug: 'lsigil-setup',
      label: 'λsigil Setup',
      type: 'Lead system and review console',
      summary:
        'Local-first lead acquisition and review system: NDJSON storage, optional OpenRouter enrichment, Next.js console, and multi-shell adapters.',
