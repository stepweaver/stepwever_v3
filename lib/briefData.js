...
export const briefData = {
  ...
  flagshipProjects: [
    ...
    },
    {
      ...
      summary:
        'Local-first lead acquisition and review: discovery through draft outreach, approval gating, notes, reporting, NDJSON resolver merge, Next.js console with a successful web-deployed run, optional OpenRouter after fetch, shell adapters.',
