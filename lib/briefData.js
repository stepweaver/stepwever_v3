...
export const briefData = {
  ...
  flagshipProjects: [
    ...
    },
    {
      ...
      summary:
        'Began as OpenClaw setup; now a local-first lead ops runtime for contractor prospecting—discovery, contact-path analysis, verification, approval-gated review, evidence notes, reporting, constrained drafts. NDJSON resolver, Next.js console (first web-deployed run done), optional OpenRouter for analyst-style passes over evidence. Multi-shell adapters on one canonical `sigil` repo.',
