...
└── utils/
    ...
    screenshots: [
      '[PLACEHOLDER] TODO: add screenshots of the chat widget, page chat, and terminal surfaces demonstrating λlambda in use.',
    ],
    challenges: [
      '[PLACEHOLDER] TODO: capture key architectural tradeoffs: multi-surface design, provider strategy, and security decisions.',
    ],
  },
  ...
  'silent-auction': {
    ...
    description:
      'Live event fundraising platform used for a real school silent auction, with real-time bidding, operator controls, and QR-based item access.',
    ...
    overview:
      '[PLACEHOLDER] Overview – TODO: describe how the silent auction platform was used end-to-end for the live event.',
    problem:
      '[PLACEHOLDER] TODO: explain the pain points of running a school silent auction manually and what needed to be fixed.',
    role:
      '[PLACEHOLDER] TODO: clarify your role as the sole/primary developer, including design, implementation, and event support.',
    solution:
      '[PLACEHOLDER] TODO: summarize the architecture (Next.js, Supabase, auth, QR flows, admin tools) at a high level.',
    features: [
      '[PLACEHOLDER] TODO: list 3–6 key features such as bidding flows, item management, admin close-out, notifications, etc.',
    ],
    techStack: {
      frontend: [
        'Next.js – Application shell and bidding UI',
        'React – Component-based UI for items, bidding, and admin views',
        '[PLACEHOLDER] TODO: add styling stack (e.g. Tailwind CSS) and any UI libraries used.',
      ],
      backend: [
        'Supabase (Postgres) – Auction items, bids, and event data',
        '[PLACEHOLDER] TODO: add API routes / server actions details once the case study is written.',
      ],
      deployment: [
        '[PLACEHOLDER] TODO: add hosting/deployment details (e.g. Vercel) and environment setup notes.',
      ],
    },
    outcome: [
      '[PLACEHOLDER] TODO: add 2–4 bullets describing how the event ran, what worked well, and what you learned.',
    ],
    screenshots: [
      '[PLACEHOLDER] TODO: add homepage / catalog screenshot.',
      '[PLACEHOLDER] TODO: add bidding screen screenshot.',
      '[PLACEHOLDER] TODO: add admin/operator dashboard screenshot.',
    ],
    challenges: [
      '[PLACEHOLDER] TODO: describe the hardest implementation or product decisions you had to make for the auction.',
    ],
  },

  // [PLACEHOLDER] Bill Planner – case study skeleton
  'bill-planner': {
    title: 'Bill Planner',
    description:
      'Paycheck-based bill and income planning app that helps you assign bills to specific pay periods and see cashflow before the month starts.',
    imageUrl: '/images/screely-llambda.png',
    link: null,
    githubRepo: '[PLACEHOLDER] TODO: add repo path for the bill planner app.',
    tags: ['Budgeting', 'Planning', 'Neon', 'Drizzle'],
    overview:
      '[PLACEHOLDER] Overview – TODO: describe your own pain around paycheck-to-paycheck planning and how this app solves it.',
    problem:
      '[PLACEHOLDER] TODO: spell out the difficulty of juggling due dates, pay dates, and variable income without a purpose-built tool.',
    role:
      '[PLACEHOLDER] TODO: explain your role in designing the data model, UX, and Neon/Drizzle setup.',
    solution:
      '[PLACEHOLDER] TODO: summarize the core workflow: assign bills to pay periods, track status, and see remaining cash per check.',
    features: [
      '[PLACEHOLDER] TODO: list 3–6 key features such as pay-period calendar, status pipeline, and bill/income summaries.',
    ],
    techStack: {
      frontend: [
        '[PLACEHOLDER] TODO: add framework (e.g. Next.js/React) and styling details.',
      ],
      backend: [
      ...
      deployment: [
        '[PLACEHOLDER] TODO: add deployment and environment details once finalized.',
      ],
    },
    outcome: [
      '[PLACEHOLDER] TODO: add 2–4 bullets covering how this changed your own planning and what value it delivers.',
    ],
    screenshots: [
      '[PLACEHOLDER] TODO: add screenshots for calendar/pay-period view and bill status pipeline.',
    ],
    challenges: [
      '[PLACEHOLDER] TODO: capture the trickiest modeling or UX decisions for mapping bills onto paychecks.',
    ],
  },
