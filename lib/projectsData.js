...
Total: 14`,
  ...
  'neon-profile-card': {
    ...
    description:
      'A glowing digital ID card experience inspired by the NETRUNNER Neon Profile Card concept. Rebuilt in our CRT aesthetic with Tailwind CSS v4, Lucide icons, and reusable React components so we can drop it into any project detail page.',
    imageUrl: null,
    ...
    features: [
      ...
      'Pure CSS hover + glow interactions—no JavaScript required',
    ...
    demoHighlights: [
      'Self-contained `NeonProfileCard` component—just swap the profile prop to reskin it',
      'Accessible status indicator and label/value pairs for screen readers',
      'Built entirely with Tailwind classes so no inline styles or global CSS overrides',
    ],
