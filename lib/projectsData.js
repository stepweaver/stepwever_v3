...
Demo injection: Projects section uses /projects/[slug] to inject the card into its case study page.`,
  ...
  'lcerebro': {
    ...
    comingSoon: true,
    serviceIntro:
      'λcerebro is in active development. It adds a Postgres-backed memory layer for AI tools, enabling persistent context and agent state across conversations.',
    problem:
      'AI agents often lack persistent memory and structured access to tools. λcerebro addresses this with a Postgres memory layer that agents can read from and write to.',
    role:
