...
└── studio-soap-stache/      # Sanity Studio (CMS)
  ...
  'lambda-orthodontics': {
    ...
    description:
      'A modern, responsive demo website for a fictional orthodontic practice. The live site (lambdaortho.vercel.app) combines marketing information with scheduling tools to showcase web-development skills. Built with vanilla JavaScript and Express.js, it uses modular components, client-side routing, and centralised data—all forms are demo-only and log submissions rather than sending emails.',
    ...
    techStack: {
      ...
      deployment: [
        'Vercel (lambdaortho.vercel.app) - Configurable port via environment variables',
      ],
    },
    projectStructure: `lambda-orthodontics/
├── app.js                 # Express server entry point; serves static files
├── package.json           # Dependencies and scripts (npm run dev, npm start)
├── public/                # Static files
│   ├── index.html         # Main HTML file
│   ├── main.js            # JavaScript entry point
│   ├── Router.js          # Client-side router; maps paths to page-render functions
│   ├── siteData.js        # Centralised content (contact, treatments, process, jobs)
│   ├── styles.css         # Global styles
│   ├── components/        # Modular components (Hero, SchedulePage, etc.)
│   └── images/            # Image assets
└── .gitignore             # Git ignore rules`,
    demoForms: [
      ...
      {
        name: 'Referral Form',
        description: 'Professional referral submissions for dentists; extensive fields; demo only',
      },
      {
    ...
    keyPages: [
      'Home: Hero, treatments summary, about, process, team preview, testimonials, FAQs, newsletter',
      'About: Mission, values, history, 2000+ patients, 15+ years, core values',
      'Treatments: Cards for Metal, Ceramic, Invisalign, Lingual; dynamic detail pages',
      'Process: Five stages—Consultation, Planning, Start, Active Treatment, Retention',
      'Schedule: Consultation booking form with date/time picker',
      'Reviews: 4.9/5 rating, patient testimonials',
      'Team: Staff profiles (orthodontists, assistants, coordinators, hygienists)',
      'Careers: Culture, benefits, open positions with application forms',
      'Contact: General inquiry form',
      'Patient Portal: Simulated login, feature highlights',
      'Referrals: Benefits, process, referral form for dental professionals',
    ],
    strengths: [
      'Professional design and responsiveness',
      'Comprehensive content across all practice areas',
      'User-friendly navigation with sticky nav and client-side routing',
      'Modular architecture with centralised data',
    ],
    limitations: [
      'All forms are non-functional—demo only',
      'No accessibility statement (alt text, keyboard navigation)',
      'No backend or persistent storage—cannot maintain sessions or store submissions',
    ],
  },
  'rpg-dice-roller': {
