...
Total: 14`,
  ...
  'lsigil-setup': {
    ...
    operationalWorkflow: [
      ...
      'Prepare constrained drafts (one problem, one offer); operator sends manually—no auto-send; reports summarize pipeline state for triage',
    ],
    engineering: [
    ...
    improveNext: [
      ...
      'Multi-pass AI review over the same evidence—challenge weak fits, surface contradictions, and tighten qualification before drafting',
