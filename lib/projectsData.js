...
Total: 14`,
  ...
  'stepweaver-dev': {
    ...
    role:
      'I owned the project end to end across multiple iterations. That included the original static version, the move to a more component-driven frontend, the rebuild in Next.js, MDX-based publishing, later Notion CMS integration, terminal UX design, project architecture, route structure, content modeling, shared chat behavior, middleware, and deployment decisions. I also directed the site’s visual and interaction language, using AI-assisted exploration and programming-theme references to help develop color systems and aesthetic variations.',
