...
Total: 14`,
  ...
  description:
    'A full-stack household cashflow planning app that maps recurring bills and expected income into paycheck windows, helping users see what is due, what is paid, and which obligations still need to be covered before the month gets away from them.',
    imageUrl: '/images/terminal_ui.png',
