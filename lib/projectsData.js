...
Demo injection: Projects section uses /projects/[slug] to inject the card into its case study page.`,
    ...
    readmeRecommendations: [
      'Highlight the Neon Profile Card in the Features section; explain homepage hero uses reusable component with Tailwind glassmorphism and Matrix Sync animation',
  ...
  'ai-integrations': {
    ...
    isService: true,
    serviceIntro:
      'These capabilities are available for hire. I built the λlambda LLM agent on this site—a shared multi-surface AI with persistent memory, server-only prompts, and channel-aware behavior. I’m also developing Open Brain, a heavy AI integration with a Postgres memory layer for tools. These can be custom-built for your needs.',
    problem:
  ...
  'open-brain': {
    title: 'Open Brain',
    description:
      'Heavy AI integration with a Postgres memory layer for tools. Actively developing persistent memory and context for AI agents.',
    imageUrl: null,
    link: null,
    tags: ['AI', 'Postgres', 'Memory Layer', 'Coming Soon'],
    isService: false,
    comingSoon: true,
    serviceIntro:
      'Open Brain is in active development. It adds a Postgres-backed memory layer for AI tools, enabling persistent context and agent state across conversations.',
    problem:
      'AI agents often lack persistent memory and structured access to tools. Open Brain addresses this with a Postgres memory layer that agents can read from and write to.',
    role:
      'Solo developer building the architecture, Postgres schema, and integration patterns for AI tool memory.',
    solution:
      'A Postgres memory layer that AI agents can use for persistent context, tool state, and conversation history. Designed for extensibility and reliability.',
    outcome: [
      'Persistent memory: Agents retain context across sessions',
      'Tool state: Structured storage for AI tool outputs and inputs',
      'Extensible: Schema and APIs designed for future tool integrations',
    ],
    features: [
      'Postgres-backed memory layer for AI tools',
      'Persistent context and agent state',
      'Schema designed for conversation history and tool outputs',
    ],
    benefits: [
      'Agents that remember past interactions',
      'Structured storage for tool use',
      'Foundation for more advanced AI integrations',
    ],
    techStack: {
      ai: [
        'Postgres - Persistent memory and state storage',
        'AI Tool Integration - Memory read/write for agents',
      ],
    },
  },
  'iam-resist': {
