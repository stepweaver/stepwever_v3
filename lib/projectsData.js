...
└── app/
  ...
  'iam-resist': {
    title: 'I AM [RESIST]',
    description:
      'A personal, self-funded project that combines activism, journalism and e-commerce into a single Next.js application. The site describes itself as "a call to awareness, a chronicle of resistance"—not an organisation or political party. Its creator, a military veteran nicknamed Yankee Samurai, documents the authoritarian drift in America and amplifies fact-based reporting and antifascist creators. The project is unapologetically antifascist and emphasises that silence in the face of fascism is surrender.',
    ...
    overview:
      'I AM [RESIST] is a personal, self-funded project that combines activism, journalism and e-commerce into a single Next.js application. The site describes itself as "a call to awareness, a chronicle of resistance"—not an organisation or political party. Its creator, a military veteran nicknamed Yankee Samurai, explains that the goal of the project is to document the authoritarian drift in America and amplify fact-based reporting and antifascist creators. The project is unapologetically antifascist and emphasises that silence in the face of fascism is surrender.',
    problem:
    ...
    mission: {
      ...
      points: [
        ...
        'Created by a veteran who believes the oath to defend the Constitution extends beyond military service; the author describes himself as a Yankee Samurai—trained to "listen between the lines" and committed to truth and liberty',
    ...
    userExperienceFindings: {
      strengths: [
        ...
        'Clear navigation: top nav provides easy access to all sections; footer repeats nav',
      ...
      areasForImprovement: [
        ...
        'Heavy layout: Intel page loads long list without pagination; filtering not immediately intuitive; "Loading…" persists after content appears',
      ],
    },
    readmeRecommendations: [
