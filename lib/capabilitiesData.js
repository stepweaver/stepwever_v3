...
export const CAPABILITY_BUCKETS = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'OpenRouter wired into the λsigil pipeline after acquisition: assistive evaluation and drafting on static HTML evidence, not search or crawl',
  ...
  },
  {
    ...
    evidence: [
      ...
      'λsigil operator console: Next.js lead review for contractor/service prospecting—contact paths, verification, approval-gated drafts, notes, reporting, append-only NDJSON (web-deployed run done)',
  ...
  },
  {
    ...
    evidence: [
      'λsigil: local-first lead ops (seed/Brave discovery, static-HTML rubric scoring, contact-path extraction, verify, approve, evidence notes, reports, constrained drafts); web-deployed console run; OpenRouter optional post-fetch',
