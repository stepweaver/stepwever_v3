...
export const CAPABILITY_BUCKETS = [
  ...
  },
  {
    ...
    relatedProjects: [
      ...
      { slug: 'stepweaver-dev', label: 'stepweaver.dev' },
      { slug: 'lsigil-setup', label: 'λsigil' },
    ],
  ...
  },
  {
    ...
    evidence: [
      ...
      'OpenRouter wired into the λsigil pipeline after acquisition: evaluation and drafting, not search or crawl',
  ...
  },
  {
    ...
    evidence: [
      ...
      'λsigil operator console: Next.js lead review with approval gating, notes, reporting, draft outreach, append-only NDJSON',
  ...
  },
  {
    ...
    evidence: [
      'λsigil: local-first lead-ops runtime (seed/Brave discovery, verify, approve, notes, reports, drafts); web-deployed console run; OpenRouter optional post-fetch',
