...
export const CAPABILITY_BUCKETS = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'λledger: cash-flow calculations with Neon PostgreSQL and Auth.js',
    ...
    relatedProjects: [
      { slug: 'silent-auction', label: 'Silent Auction Platform' },
      { slug: 'bill-planner', label: 'λledger' },
  ...
  },
  {
    ...
    evidence: [
      'λledger: household cash-flow planning with paycheck windows and real calculation logic',
