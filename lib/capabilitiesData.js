...
export const CAPABILITY_BUCKETS = [
  ...
  },
  {
    ...
    relatedProjects: [
      ...
      { slug: 'stepweaver-dev', label: 'stepweaver.dev' },
      { slug: 'lsigil-setup', label: 'λsigil Setup' },
    ],
  ...
  },
  {
    ...
    evidence: [
      ...
      'OpenRouter enrichment wired into the λsigil lead review pipeline',
  ...
  },
  {
    ...
    evidence: [
      ...
      'λsigil review console: Next.js-based lead review surface with append-only storage',
  ...
  },
  {
    ...
    evidence: [
      'λsigil: local-first lead acquisition with seed/Brave acquisition, NDJSON storage, and OpenRouter enrichment',
