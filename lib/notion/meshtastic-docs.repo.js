...
/**
 * Flat list for prev/next navigation: Introduction first, then all docs in section/order.
 */
export function getFlatDocList(docs) {
  const intro = { slug: null, title: "Introduction" };
  return [intro, ...docs];
}
