  ...
  'lead-systems': [
    {
      ...
      reason:
        'Contractor lead ops runtime: seed or Brave discovery, evidence bundles from static HTML, contact-path interpretation (forms/booking vs noisy email), verification, optional analyst-style OpenRouter passes, approval-gated drafts, append-only notes and reporting, NDJSON resolver, web-deployed Next.js console.',
    },
    {
