  ...
  'lead-systems': [
    {
      ...
      label: 'λsigil',
      reason:
        'Local-first lead-ops runtime: discovery, verification, approval gating, notes, reporting, draft outreach, NDJSON + resolver, Next.js console (web-deployed), optional OpenRouter, multi-shell adapters.',
    },
    {
