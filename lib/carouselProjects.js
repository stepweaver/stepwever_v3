export const CAROUSEL_PROJECTS = [
  ...
  },
  {
    ...
    description:
      'Built a terminal-styled RPG dice roller with mixed dice pools, hold-and-reroll interactions, keyboard shortcuts, and local roll history. Designed as a real utility inside the portfolio, not just a demo.',
    imageUrl: '/images/screely-llambda.png',
  ...
  },
  {
    ...
    description:
      'Command-driven portfolio interface built with Next.js and React. Visitors can browse my resume and Codex, chat with λlambda, send messages through a guided terminal flow, check weather, roll RPG dice, and launch small interactive features from one branded command surface.',
  ...
  },
  {
    ...
    description: 'GA4 setup, event tracking, and reporting that turn website traffic into usable business signals.',
    imageUrl: null,
