export const CAROUSEL_PROJECTS = [
  {
    title: 'λcerebro',
    description:
      'Postgres-backed memory for thoughts. Capture via Slack, retrieve via MCP. Your second brain, owned by you.',
    imageUrl: '/cerebro.png',
    keywords: ['AI', 'Postgres', 'MCP', 'Memory Layer', 'In Development'],
    actions: [
