export const CAROUSEL_PROJECTS = [
  ...
  },
  {
    title: 'I AM [RESIST]',
    description:
      'High-performance content and commerce platform powered by Notion as a headless CMS, Stripe, and Printify, built to publish, curate, and ship at scale.',
    imageUrl: '/images/screely-resist.png',
    keywords: ['Notion CMS', 'Next.js', 'E-commerce', 'Stripe', 'Printify'],
    actions: [
      'Notion-powered feeds for voices, protest music, book club, journal, and timeline content',
      'Stripe + Printify shop with Supabase-backed orders and webhooks for fully automated fulfillment',
    ],
  ...
  },
  {
    title: 'Bill Planner',
    description:
      'Paycheck-based bill and income planning app that lets you assign bills to pay periods and track planned vs pending vs paid using Neon + Drizzle.',
    imageUrl: '/images/screely-llambda.png',
    keywords: ['Budgeting', 'Planning', 'Neon', 'Drizzle'],
    actions: [
      'Assign bills to specific pay periods so you can see which paycheck covers what before the month starts',
      'Track the lifecycle of each bill (planned → pending → paid) with an at-a-glance view of upcoming obligations',
    ],
  ...
  },
  {
    ...
    description:
      'Demo orthodontic practice site built with vanilla JavaScript and Express.js, with modular components, client-side routing, and a centralised content file.',
    imageUrl: '/images/screely-lambda.png',
    keywords: ['Healthcare', 'Website', 'Vanilla JS', 'Demo Forms'],
    actions: [
      'Component-style ES modules with a custom Router for client-side navigation and dynamic treatment pages',
      'Six demo forms (contact, schedule, referral, careers, portal, newsletter) wired with validation and feedback for agency-style pitches',
    ],
  ...
  },
  {
    ...
    description:
      'Generalized service-business marketing site demo with vanilla JavaScript and dynamic SEO-friendly pages derived from prior agency work.',
    imageUrl: '/images/screely-llambda.png',
    keywords: ['Service Business', 'Marketing Site', 'SEO', 'Vanilla JS'],
    actions: [
      'Dynamic service and location pages designed to showcase SEO-friendly content patterns for local businesses',
      'Lightweight vanilla JavaScript architecture suitable for agency delivery and customization',
    ],
    tags: ['Web Development', 'SEO', 'Agency Demo'],
  ...
  },
  {
    ...
    description:
      'Zero-cost, zero-infrastructure shower scheduling app for a community food pantry, built entirely with Google Apps Script and Google Sheets.',
    imageUrl: '/images/screely-llambda.png',
    keywords: ['Google Apps Script', 'Community Service', 'Zero Infrastructure'],
    actions: [
      'Self-service mobile booking with check-in windows so guests can leave instead of waiting around all day',
      'Admin dashboard backed by Google Sheets with automatic cleanup, rate limiting, and lock protection to prevent double-bookings',
    ],
  ...
  },
  {
    ...
    description:
      'Family orthodontic expansion and visit tracker to log turns, appointments, and progress over time.',
    imageUrl: '/images/screely-llambda.png',
    keywords: ['Health Tracking', 'Family Tools'],
    actions: [
      'Tracks expansion turns and orthodontic visits so treatment plans are easy to follow at home',
      'Built as a pragmatic, real-life tool to remove friction from a long-running family process',
    ],
  ...
  {
    title: 'Soap Stache',
    description: 'E-commerce platform for handcrafted soaps with a full shopping cart, Sanity CMS, and Stripe payments.',
    imageUrl: '/images/screely-stache.png',
    keywords: ['E-commerce', 'Next.js', 'Sanity CMS', 'Stripe'],
    actions: [
      'Complete shopping cart and Stripe Checkout with Sanity-powered product catalog',
      'Michigan-themed branding, responsive design, and content editor autonomy via Sanity Studio',
    ],
