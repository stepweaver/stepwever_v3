...
const CARD_COPY = {
  ...
  'lsigil-setup': {
    description:
      'Bootstrapping work for λsigil: a named operational agent inside OpenClaw with a defined identity, a verified WSL workspace, a confirmed gateway setup, and deliberate decisions about model routing and agent scope.',
    actions: [
      'Defined IDENTITY.md, SOUL.md, USER.md, MEMORY.md, and AGENTS.md to give λsigil a stable, file-based identity that persists across sessions',
      'Resolved a Windows/WSL workspace directory mismatch, verified the OpenClaw gateway service, and settled model routing policy for agent tasks',
    ],
  },
};
