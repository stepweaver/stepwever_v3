...
const CARD_COPY = {
  ...
  'lsigil-setup': {
    description:
      'Built λsigil as an OpenClaw operator with a versioned repo, scoped identity files, and an early lead-generation workflow for real execution experiments.',
    builtFor: 'an execution-oriented operator inside λstepweaver',
    solved: 'the gap between launching an agent and having one I could actually use',
    delivered: 'a versioned operator system with real lead-generation experiments and a path toward broader agent workflows',
    actions: [
      'Defined λsigil through explicit operating files, repo structure, validation, and a manual-first commercial workflow',
      'Used ChatGPT, OpenClaw, OpenRouter, and Cursor together to research, shape, and refine an operator that could return real lead data',
    ],
  },
};
