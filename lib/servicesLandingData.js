    ...
    secondary: [
      {
        ...
        reason:
          'Local-first lead ops for contractor prospecting: discovery, contact-path work on static HTML, verification, evidence notes, approval-gated drafts, and reporting—Next.js console with a successful web-deployed run, not a generic agent pitch.',
        linkLabel: 'View project',
      },
      {
