    ...
    secondary: [
      {
        ...
        reason:
          'From OpenClaw setup to operator runtime: discovery, evidence-oriented qualification, contact paths (forms/booking/mail), verification, optional multi-pass model review, approval-gated drafts, reporting—Next.js console with a completed web-deployed run; sharpening toward outcome calibration.',
        linkLabel: 'View project',
      },
      {
