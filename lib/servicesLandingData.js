    ...
    secondary: [
      {
        ...
        title: 'λsigil',
        reason:
          'Local-first lead acquisition and review runtime: discovery, verification, approval gating, notes, reporting, and draft outreach with a web-deployed operator console.',
        linkLabel: 'View project',
      },
      {
