...
export const metadata = {
  title: 'Automation and Integration | Stephen Weaver',
  description:
    'Tool handoffs, data sync, workflow automation, reporting flows, and AI-assisted operational glue. Reduce manual work. Make systems talk to each other.',
  alternates: {
    canonical: 'https://stepweaver.dev/services/automation',
  },
  openGraph: {
    title: 'Automation and Integration | Stephen Weaver',
    description:
      'Tool handoffs, data sync, workflow automation, reporting, and AI-assisted operational glue.',
    url: 'https://stepweaver.dev/services/automation',
    type: 'website',
  },
};

const page = servicePages['automation'];
const proofItems = getProofForLane('automation');
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <section className='relative z-30 py-8'>
          <header className='mb-6'>
            ...
            <h2 className='font-ibm text-xl sm:text-2xl text-text'>What this covers</h2>
          </header>
        ...
        <section className='relative z-30 py-4'>
          <header className='mb-4'>
            ...
            <h2 className='font-ibm text-xl sm:text-2xl text-text'>What it does not cover</h2>
          </header>
