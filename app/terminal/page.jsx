...
const Terminal = dynamic(() => import('@/components/Terminal/Terminal'), {
  ...
  loading: () => (
    <div className='h-full flex items-center justify-center'>
      <div className='hud-panel p-6 w-full max-w-sm motion-safe:animate-pulse'>
        <div className='text-xs tracking-[0.2em] text-neon/50 font-ocr uppercase'>
          LINK ESTABLISHED...
        </div>
        <div className='mt-4 space-y-3'>
          <div className='h-3 bg-neon/10 w-3/4' />
          <div className='h-3 bg-neon/10 w-1/2' />
          <div className='h-3 bg-neon/10 w-2/3' />
        </div>
      </div>
    </div>
  ),
